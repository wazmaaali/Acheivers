...
function Cart() {
  ...
  console.log("9999 value: ", location.state.value);
    ...
    <div className="CartContainer">
      ...
      <div className="Cart-Items">
        ...
        <div className="about">
          ...
          <img src="images/veg.png" alt="Cart" style={{ height: "30px" }} />
        </div>
      ...
      <div className="Cart-Items pad">
        <div className="image-box">
          <img src="images/grapes.png" alt="Cart" style={{ height: "120px" }} />
        </div>
        <div className="about">
